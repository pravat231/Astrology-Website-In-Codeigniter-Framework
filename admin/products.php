...
$sql1="SELECT * FROM website_pro_ser WHERE pro_ser_type='product' ORDER BY pro_ser_id DESC"; 
$rowsperpage = 10; 
    ...
    <td class="content"><div id="main_column" class="clear">
        ...
        <div>
          <div class="clear mainbox-title-container">
            <div class="tools-container"><span class="action-add"><a href="add_products.php">Add Product</a></span></div>
              ...
              <div id="pagination_contents">
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table sortable">
                  <tr>
                    ...
                    <th width="25%"><a class="cm-ajax" href="javascript:void(0)" rev="pagination_contents">Product Name</a></th>
                    <th width="33%"><a class="cm-ajax" href="javascript:void(0)" rev="pagination_contents">Product Intro</a></th>
                  ...
                  <tr class="table-row">
                    ...
                    <td class="nowrap"><a class="tool-link" href="edit_products.php?pro_ser_id=<?php echo $row['pro_ser_id']; ?>">Edit</a> &nbsp;&nbsp;|
                      <ul class="cm-tools-list tools-list">
                        <?php if($row['pro_ser_status']=='inactive'){ ?>
                        <li><a href="products.php?act=active&pro_ser_id=<?php echo $row['pro_ser_id']; ?>" onclick="return confirm('Do you want to activate this.')">active</a> | </li>
                        <?php }else{ ?>
                        <li><a href="products.php?act=inactive&pro_ser_id=<?php echo $row['pro_ser_id']; ?>" onclick="return confirm('Do you want to inactivate this.')">inactive</a> | </li>
                        <?php } ?>
                        <li> <a href="products.php?act=del&pro_ser_id=<?php echo $row['pro_ser_id']; ?>" onclick="return confirm('Do you want to delete this.')">Delete</a></li>
                      </ul></td>
                  </tr>
                  <?php }} ?>
                </table>
