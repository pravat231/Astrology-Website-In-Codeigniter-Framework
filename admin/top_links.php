...
$sql1="SELECT * FROM website_pages WHERE parent_id!='-1' AND top_links='yes' ORDER BY page_id DESC";
$rowsperpage = 10; 
    ...
    <td class="content"><div id="main_column" class="clear">
        ...
        <div>
          <div class="clear mainbox-title-container">
          	<div class="tools-container"><span class="action-add"><a href="add_top_link.php">Add Pages</a></span></div>
              ...
              <div id="pagination_contents">
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table sortable">
                  <tr>
                    ...
                    <th width="15%"><a class="cm-ajax" href="javascript:void(0)" rev="pagination_contents">Status</a></th>
                  ...
                  <tr class="table-row">
                    ...
                    <td class="nowrap"><a class="tool-link" href="edit_top_link.php?page_id=<?php echo $row['page_id']; ?>">Edit</a> &nbsp;&nbsp;|
                      <ul class="cm-tools-list tools-list">
                        <li> <a href="top_links.php?act=del&page_id=<?php echo $row['page_id']; ?>" onclick="return confirm('Do you want to delete this.')">Delete</a></li>
                      </ul></td>
                  </tr>
                  <?php }} ?>
                </table>
