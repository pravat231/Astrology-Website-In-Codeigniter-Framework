    ...
    <form id="listing_form1" name="listing_form1" action="" method="post" class="cm-form-highlight" onSubmit="return check_step1();">
      ...
      <div id="content_general">
        ...
        <div class="form-field">
          ...
          <input id="saloon_text" type="text" name="saloon_text" class="input-text<?php if($saloon_text_error!=NULL){ ?> cm-failed-field<?php } ?>" size="32" value="<?php echo $_POST['saloon_text']; ?>" />
        ...
        <div class="form-field">
          ...
          <textarea id="saloon_desc" name="saloon_desc" cols="29" rows="4" class="input-textarea-long<?php if($saloon_desc_error!=NULL){ ?> cm-failed-field<?php } ?>"><?php echo $_POST['saloon_desc']; ?></textarea>
        ...
        <div class="form-field">
          ...
          <input type="text" id="saloon_address" name="saloon_address" class="input-text<?php if($saloon_address_error!=NULL){ ?> cm-failed-field<?php } ?>" size="32" value="<?php echo $_POST['saloon_address']; ?>" />
        ...
        <div class="form-field">
          ...
          <input type="text" id="city_code" name="city_code" class="input-text<?php if($city_code_error!=NULL){ ?> cm-failed-field<?php } ?>" size="32" value="<?php echo $_POST['city_code']; ?>" />
        ...
        <div class="form-field">
          ...
          <input type="text" id="prov_name" name="prov_name" class="input-text<?php if($prov_name_error!=NULL){ ?> cm-failed-field<?php } ?>" size="32" value="<?php echo $_POST['prov_name']; ?>" />
        ...
        <div class="form-field">
          ...
          <input type="text" id="postal_code" name="postal_code" class="input-text<?php if($postal_code_error!=NULL){ ?> cm-failed-field<?php } ?>" size="32" value="<?php echo $_POST['postal_code']; ?>" />
        ...
        <div class="form-field">
          ...
          <input id="search_phone_area_code" type="text" name="phone_code1" class="input-text<?php if($phone_code1!=NULL){ ?> cm-failed-field<?php } ?>" size="3" maxlength="3" onKeyUp="javascript:onKeyUpValidateField('search_phone_area_code','^\\d{1,3}$');move_focus(event.keyCode,'search_phone_area_code','search_phone_1','3');" value="<?php echo $_POST['phone_code1']; ?>" />

          <input id="search_phone_1" type="text" name="phone_code2" class="input-text<?php if($phone_code2!=NULL){ ?> cm-failed-field<?php } ?>" size="3" maxlength="3" onKeyUp="javascript:onKeyUpValidateField('search_phone_1', '^\\d{1,3}$');move_focus( event.keyCode,'search_phone_1','search_phone_2','3');" value="<?php echo $_POST['phone_code2']; ?>" />

          <input id="search_phone_2" type="text" name="phone_code3" class="input-text<?php if($phone_code3!=NULL){ ?> cm-failed-field<?php } ?>" size="4" maxlength="4" onKeyUp="javascript:onKeyUpValidateField('search_phone_2','^\\d{1,4}$');" value="<?php echo $_POST['phone_code3']; ?>" />
        ...
        <div class="form-field">
          ...
          <input type="text" id="website" name="website" size="32" value="<?php echo $_POST['website']; ?>" class="input-text" />
        ...
        <div class="form-field">
          ...
          <input type="text" id="email" name="email" size="32" value="<?php echo $_POST['email']; ?>" class="input-text" />
      ...
      <input type="submit" name="dispatch1" value="Submit" />
