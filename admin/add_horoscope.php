              ...
              <div class="cm-tabs-content">
                <form id="service_form" name="service_form" action="" method="post" enctype="multipart/form-data" class="cm-form-highlight">
                  <div id="content_general">
                    <fieldset>
                    <h2 class="subheader">Horoscope Information</h2>
                    <div class="form-field">
                      <label for="moon_sign" class="cm-required">Moon Sign:</label>
                      <input id="moon_sign" type="text" name="moon_sign" class="input-text<?php if($moon_sign_error!=NULL){ ?> cm-failed-field<?php } ?>" size="32" value="" />
                     </div>
                    <div class="form-field">
                      <label for="service_desc">Horoscope Description:</label>
                      <textarea id="horoscope_desc" name="horoscope_desc" cols="29" rows="4" class="input-textarea-long<?php if($horoscope_desc_error!=NULL){ ?> cm-failed-field<?php } ?>"></textarea>
                      <script type="text/javascript">
					  CKEDITOR.replace('horoscope_desc' );
                    ...
                    <div class="form-field">
                     ...
                     <div class="form-field">
                      <label for="horoscope_image">Image:</label>
                      <input type="file" id="horoscope_image" name="horoscope_image" class="input-text<?php if($horoscope_image_error!=NULL){ ?> cm-failed-field<?php } ?>" size="32" value="" />
                     <?php echo $horoscope_image_error; ?></div>
                    <div class="form-field">
                      <label for="horoscope_status">Status:</label>
                      <select name="horoscope_status" id="horoscope_status" style="width:257px">
