...
<table cellpadding="0" cellspacing="0" border="0">
  <tr>
    ...
    <td><table cellpadding="0" cellspacing="0" border="0">
        ...
        <table cellpadding="0" cellspacing="0"  border="0">
              <tr>
                <td align="left" height="84" width="96"><img height="84" width="96" title="<?php echo $single_product_data['pro_ser_name']; ?>" alt="<?php echo $single_product_data['img_alt']; ?>" src="<?php echo base_url(); ?>pro_ser_image/<?php echo ($single_product_data['pro_ser_img']!=NULL)?$single_product_data['pro_ser_img']:'default_image'; ?>.jpg" style="padding:2px"></td>
