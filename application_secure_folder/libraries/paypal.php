...
class Paypal {
	...
	var $API_UserName="zeineddine1_api1.hotmail.com";
	var $API_Password="LPAHTWS5U74J3S2G";
	var $API_Signature="A-VoKOU.uOrvVt4bwe-ud.p8jeMCApCtKxNk4KRF16pskB4EWJa2fc9V";
	
	/*$SandboxFlag = true;
	$API_UserName="pravat_1298456209_biz_api1.gmail.com";
	$API_Password="1298456221";
	$API_Signature="AFcWxV21C7fd0v3bYYYRCpSSRl31AssnuQQ9XhQxIepcKx85Hzxz6spw";*/
	...
	*/
	function CallMarkExpressCheckout( $paymentAmount, $currencyCodeType, $paymentType, $returnURL, 
									  ...
									  $shipToCountryCode, $shipToZip, $shipToStreet2, $phoneNum, $shipToEmail) 
	{
		//------------------------------------------------------------------------------------------------------------------------------------
		// Construct the parameter string that describes the SetExpressCheckout API call in the shortcut implementation
		...
		$nvpstr = $nvpstr . "&PAYMENTREQUEST_0_EMAIL=" . $shipToEmail;
